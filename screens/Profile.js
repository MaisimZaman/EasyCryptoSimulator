            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Text style={{ color: COLORS.white, ...FONTS.h3 }}>{auth.currentUser.email}</Text>
                            <Text style={{ color: COLORS.lightGray3, ...FONTS.body4 }}>Name: {auth.currentUser.displayName}</Text>
                        </View>
